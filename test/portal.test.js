...
test('portal inclui Vulcao Ardente e nao invalida a lista quando apenas o tempo passa', () => {
  ...
  const ctx = { P, scrOpen: 'portal', charTab: 'equip', shopOpen: false, shopTab: 'buy', shopCat: 0, shopSel: null, shopSold: [], invOpen: false, bagFilter: 0, skSel: '', mapView: 'vila', socTab: '', FRIENDS: [], PARTY: null, W_: { name: 'vila' }, skillPoints: () => 0, nearMerchant: () => false, bsOpen: false, bsSel: null };
